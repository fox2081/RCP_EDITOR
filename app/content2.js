...
module.controller("ctrl", function ($rootScope, $scope, $timeout) {
    ...
    var embed = '<iframe src="http://www.tudou.com/programs/view/html5embed.action?type=2&code=fxWLeC_PXmA&lcode=7uAYNvFA-Y0&resourceId=363454370_06_05_99" allowtransparency="true" allowfullscreen="true" allowfullscreenInteractive="true" scrolling="no" border="0" frameborder="0" style="width:640px;height:360px;"></iframe>';
    for(var i = 0;i < 100;i++){
        $scope.contentOrigin.childItems.push(
            {
                type: "embed",
                data: {
                    id: "321312",
    ...
    $scope.content = JSON.parse(localStorage.getItem('data2')) || $scope.contentOrigin;
    ...
    $scope.testContent = '<p>测试内容</p>' +
        ...
        '</table>' +
        '<p>&nbsp;</p> ';
    //$scope.testContent = "<p>点击添加内容</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p>";
    ...
    $scope.getData = function () {
        $scope.content = JSON.parse(localStorage.getItem('data2'));
    };
